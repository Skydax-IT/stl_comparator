...
bpy.context.object.modifiers["Boolean"].object = bpy.data.objects[stl1]
bpy.ops.object.modifier_apply(modifier="Boolean")

bpy.ops.export_mesh.stl(filepath=f'{output_path}/bool_result_1.stl' ,check_existing=True, filter_glob=stl2, use_selection=True, global_scale=1.0, use_scene_unit=False, ascii=False, use_mesh_modifiers=True, batch_mode="OFF", axis_forward="Y", axis_up="Z")
